...
'load-data-error': '加载数据时发生错误',
        ...
        'form-fault-category-mechanical': '机械',
        'form-fault-category-electrical': '电气',
        'form-fault-category-software': '软件',
        'form-fault-category-network': '网络',
        'form-fault-category-other': '其他',
        ...
        'form-select-fault-category': '请选择故障分类',
        'form-select-fault-level': '请选择故障等级',
    ...
    en: {
        ...
        'form-select-fault-category': 'Please select a fault category',
        'form-select-fault-level': 'Please select a fault level',
        ...
        'ai-analyzing': 'Analyzing with AI, please wait...',
        ...
        'form-fault-category-mechanical': 'Mechanical',
        'form-fault-category-electrical': 'Electrical',
        'form-fault-category-software': 'Software',
        'form-fault-category-network': 'Network',
        'form-fault-category-other': 'Other',
        ...
        'no-feedback-filter': 'No feedback in this category',
        'load-error': 'Failed to load feedback',
        'like-error': 'Failed to like',
        'comment-error': 'Failed to comment',
        ...
        'share-success': 'Copied to clipboard',
        'just-now': 'Just now',
        ...
        // Feedback Admin Page
        'feedback-admin-title': 'Feedback Management',
        'nav-feedback-admin': 'Feedback Admin',
        'refresh-btn': 'Refresh',
        'loading': 'Loading...',
        'no-feedback': 'No feedback available',
        'load-error': 'Error loading feedbacks',
        ...
        'status-completed': 'Completed',
        'status-pending': 'Pending',
        'feedback-marked-completed': 'Feedback marked as completed',
        'feedback-update-error': 'Failed to update feedback',
        'delete-confirm': 'Are you sure you want to delete this feedback?',
        'feedback-deleted': 'Feedback deleted successfully',
        'feedback-delete-error': 'Failed to delete feedback',
        'load-details-error': 'Failed to load feedback details',
        ...
        'feedback-submit-error': '提交反馈失败',
        
        // Forum Features
        'new-feedback-btn': '新建反馈',
        'filter-all': '全部',
        'filter-bug': 'Bug',
        'filter-suggestion': '建议',
        'filter-other': '其他',
        'filter-popular': '热门',
        'filter-recent': '最新',
        'no-feedback': '暂无反馈信息',
        'no-feedback-filter': '该分类下暂无反馈',
        'load-error': '加载反馈失败',
        'like-error': '点赞失败',
        'dislike-error': '点踩失败',
        'comment-error': '评论失败',
        ...
        // Feedback Admin Page
        'feedback-admin-title': '反馈管理',
        'nav-feedback-admin': '反馈管理',
        'refresh-btn': '刷新',
        'loading': '加载中...',
        'no-feedback': '暂无反馈',
        'load-error': '加载反馈失败',
        ...
        'status-completed': '已完成',
        'status-pending': '待处理',
        'feedback-marked-completed': '反馈已标记为已完成',
        'feedback-update-error': '更新反馈失败',
        'delete-confirm': '确定要删除此反馈吗？',
        'feedback-deleted': '反馈已成功删除',
        'feedback-delete-error': '删除反馈失败',
        'load-details-error': '加载反馈详情失败',
        'submit-time': '提交时间',
        'device-info': '设备信息',
        'user-agent': '用户代理',
        'screen-size': '屏幕尺寸',
...
console.log("language.js is loaded");
